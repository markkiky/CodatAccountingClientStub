...
class PaymentMethodsApi(object):
    ...
    def get_payment_method(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_payment_method_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_payment_method_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_payment_method_with_http_info(self, **kwargs):  # noqa: E501
        """Get payment method  # noqa: E501

        Gets the specified payment method for a given company.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payment_method_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/companies/{companyId}/data/paymentMethods/{paymentMethodId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_payment_methods(self, **kwargs):  # noqa: E501
        """List all payment methods  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_payment_methods_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_payment_methods_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_payment_methods_with_http_info(self, **kwargs):  # noqa: E501
        """List all payment methods  # noqa: E501

        Gets the payment methods for a given company.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_payment_methods_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/companies/{companyId}/data/paymentMethods', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaymentMethods',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
