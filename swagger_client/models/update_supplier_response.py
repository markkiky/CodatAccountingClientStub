...
class UpdateSupplierResponse(object):
    ...
    def __init__(self):  # noqa: E501
        """UpdateSupplierResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateSupplierResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSupplierResponse):
            return False
