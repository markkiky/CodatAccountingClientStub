...
from swagger_client.models.create_invoice_response import CreateInvoiceResponse  # noqa: E501
...
class TestCreateInvoiceResponse(unittest.TestCase):
    ...
    def testCreateInvoiceResponse(self):
        ...
        # model = swagger_client.models.create_invoice_response.CreateInvoiceResponse()  # noqa: E501
        pass
