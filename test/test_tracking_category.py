...
from swagger_client.models.tracking_category import TrackingCategory  # noqa: E501
...
class TestTrackingCategory(unittest.TestCase):
    ...
    def testTrackingCategory(self):
        ...
        # model = swagger_client.models.tracking_category.TrackingCategory()  # noqa: E501
        pass
