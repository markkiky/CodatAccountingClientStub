...
from swagger_client.models.cash_flow_statement import CashFlowStatement  # noqa: E501
...
class TestCashFlowStatement(unittest.TestCase):
    ...
    def testCashFlowStatement(self):
        ...
        # model = swagger_client.models.cash_flow_statement.CashFlowStatement()  # noqa: E501
        pass
