...
from swagger_client.models.update_invoice_response import UpdateInvoiceResponse  # noqa: E501
...
class TestUpdateInvoiceResponse(unittest.TestCase):
    ...
    def testUpdateInvoiceResponse(self):
        ...
        # model = swagger_client.models.update_invoice_response.UpdateInvoiceResponse()  # noqa: E501
        pass
