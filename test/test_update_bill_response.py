...
from swagger_client.models.update_bill_response import UpdateBillResponse  # noqa: E501
...
class TestUpdateBillResponse(unittest.TestCase):
    ...
    def testUpdateBillResponse(self):
        ...
        # model = swagger_client.models.update_bill_response.UpdateBillResponse()  # noqa: E501
        pass
